            ...
            <v-flex xs12 md9 lg9 class="">
                <v-layout row wrap>
                    ...
                    <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
                        ...
                        <p class="google-font" style="font-size:110%">Get updated with the latest How to's of CTF and Tricks to Win CTF</p>
                    </v-flex>

                    <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
                        <v-icon large style="font-size:300%">airplay</v-icon>
                        <p class="google-font" style="font-size:130%">CTF Training</p>
                        <p class="google-font" style="font-size:110%">Get hands-on experience and Learn to Hack Applications with guidance</p>
                    </v-flex>

                    <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
                        <v-icon large style="font-size:300%">school</v-icon>
                        <p class="google-font" style="font-size:130%">Certification</p>
                        <p class="google-font" style="font-size:110%">Gain Invaluable Practical Experiences. Become a part of a Global Cyber Security Community</p>
                    </v-flex>

                    <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
                        <v-icon large style="font-size:300%">code</v-icon>
                        <p class="google-font" style="font-size:130%">Improve Skills</p>
                        <p class="google-font" style="font-size:110%">Participating in this event will Improve your Pentesting skills Beginner to Expert Level</p>
                    </v-flex>
