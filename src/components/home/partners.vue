    ...
    <v-container class="pa-0 pb-5">
        <v-layout wrap align-center justify-center row fill-height>
            ...
            <v-flex xs12 md12 class="mt-2">
                <p class="google-font my-2" style="font-size:110%">Event Partners</p>
                        ...
                        <v-card class="elevation-0 pa-0 ma-0 transparent">
                            <v-container grid-list-sm fluid class="pa-0 ma-0">
                                <v-layout row wrap class="ma-0 pa-0">
                                    ...
                                    <v-card flat tile class="d-flex pa-2 ma-1 elevation-1" style="border-radius:5px;border-width: 0px; border-style: solid;">
            ...
            <v-flex xs12 md12 class="mt-3">
                <p class="google-font my-2" style="font-size:110%">Template courtesy</p>
